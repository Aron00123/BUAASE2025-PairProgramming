...
assert.strictEqual(greedy_snake_fn_checker([8,8,8,7,7,7,7,8], [4,4], greedy_snake_move) >= 0, true);
assert.strictEqual(greedy_snake_fn_checker([1,1,2,1,2,2,3,2], [3,1], greedy_snake_move) >= 0, true);
